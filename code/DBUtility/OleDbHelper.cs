...
namespace TVMS.DBUtility {
    ...
    public abstract class OleDbHelper {
        ...
        public static readonly string ConnectionStringLocalTransaction = TVMS.Properties.Settings.Default.SQLConnString;
        ...
        /// <param name="cmdParms">an array of OleDbParameters to be cached</param>
        ...
        /// <returns>Cached OleDbParameters array</returns>
